...
data Rule = Rule { rule8 :: Bool -- Color of field with neighbors True-True-True
                 , rule7 :: Bool -- Color of field with neighbors True-True-False
                 , rule6 :: Bool -- Color of field with neighbors True-False-True
                 , rule5 :: Bool -- Color of field with neighbors True-False-False
                 , rule4 :: Bool -- Color of field with neighbors False-True-True
                 , rule3 :: Bool -- Color of field with neighbors False-True-False
                 , rule2 :: Bool -- Color of field with neighbors False-FalseTrue
                 , rule1 :: Bool -- Color of field with neighbors False-False-False
                 } deriving Show
...
main = do
  ...
  let rule = Rule { rule8 = intToBool $ div (mod ruleInt 256) 128
                  , rule7 = intToBool $ div (mod ruleInt 128) 64
                  , rule6 = intToBool $ div (mod ruleInt 64) 32
                  , rule5 = intToBool $ div (mod ruleInt 32) 16
                  , rule4 = intToBool $ div (mod ruleInt 16) 8
                  , rule3 = intToBool $ div (mod ruleInt 8) 4
                  , rule2 = intToBool $ div (mod ruleInt 4) 2
                  , rule1 = intToBool $ mod ruleInt 2
                  }
